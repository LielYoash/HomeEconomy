  ...
  <title>Sign Up</title>
    ...
    <script>
        function validateForm() {
            ...
            var selectedFamilyName = document.getElementById('<%= ddlFamilyName.ClientID %>').value;

            if ( roleName === "" || email === "" || password === "" || firstName === "" || lastName === "" || birthdate === "" || selectedFamilyName === "") {
...
<body>
    <form id="form1" runat="server">
        <div id="container">
            ...
            <asp:DropDownList ID="ddlFamilyName" CssClass="dropdown" runat="server"></asp:DropDownList>
